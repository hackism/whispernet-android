...
import com.whispernet.android.onboarding.BluetoothCheckScreen
import com.whispernet.android.onboarding.BluetoothStatus
import com.whispernet.android.onboarding.BluetoothStatusManager
import com.whispernet.android.onboarding.BatteryOptimizationManager
import com.whispernet.android.onboarding.BatteryOptimizationPreferenceManager
import com.whispernet.android.onboarding.BatteryOptimizationScreen
import com.whispernet.android.onboarding.BatteryOptimizationStatus
import com.whispernet.android.onboarding.InitializationErrorScreen
import com.whispernet.android.onboarding.InitializingScreen
import com.whispernet.android.onboarding.LocationCheckScreen
import com.whispernet.android.onboarding.LocationStatus
import com.whispernet.android.onboarding.LocationStatusManager
import com.whispernet.android.onboarding.OnboardingCoordinator
import com.whispernet.android.onboarding.OnboardingState
import com.whispernet.android.onboarding.PermissionExplanationScreen
import com.whispernet.android.onboarding.PermissionManager
import com.whispernet.android.ui.ChatScreen
import com.whispernet.android.ui.ChatViewModel
import com.whispernet.android.ui.theme.WhispernetTheme
import com.whispernet.android.nostr.PoWPreferenceManager
...
class MainActivity : ComponentActivity() {
    ...
    private fun handleNotificationIntent(intent: Intent) {
        val shouldOpenPrivateChat = intent.getBooleanExtra(
            com.whispernet.android.ui.NotificationManager.EXTRA_OPEN_PRIVATE_CHAT, 
            false
        )
        
        val shouldOpenGeohashChat = intent.getBooleanExtra(
            com.whispernet.android.ui.NotificationManager.EXTRA_OPEN_GEOHASH_CHAT,
            false
        )
        
        when {
            shouldOpenPrivateChat -> {
                val peerID = intent.getStringExtra(com.whispernet.android.ui.NotificationManager.EXTRA_PEER_ID)
                val senderNickname = intent.getStringExtra(com.whispernet.android.ui.NotificationManager.EXTRA_SENDER_NICKNAME)
            ...
            shouldOpenGeohashChat -> {
                val geohash = intent.getStringExtra(com.whispernet.android.ui.NotificationManager.EXTRA_GEOHASH)
                ...
                if (geohash != null) {
                    ...
                    val level = when (geohash.length) {
                        7 -> com.whispernet.android.geohash.GeohashChannelLevel.BLOCK
                        6 -> com.whispernet.android.geohash.GeohashChannelLevel.NEIGHBORHOOD
                        5 -> com.whispernet.android.geohash.GeohashChannelLevel.CITY
                        4 -> com.whispernet.android.geohash.GeohashChannelLevel.PROVINCE
                        2 -> com.whispernet.android.geohash.GeohashChannelLevel.REGION
                        else -> com.whispernet.android.geohash.GeohashChannelLevel.CITY // Default fallback
                    }
                    val geohashChannel = com.whispernet.android.geohash.GeohashChannel(level, geohash)
                    val channelId = com.whispernet.android.geohash.ChannelID.Location(geohashChannel)
