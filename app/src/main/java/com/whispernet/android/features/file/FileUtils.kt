package com.whispernet.android.features.file
...
object FileUtils {
    ...
    fun saveIncomingFile(
        context: Context,
        file: com.whispernet.android.model.WhispernetFilePacket
    ): String {
    ...
    /**
     * Classify WhispernetMessageType from MIME string used in file messages.
     */
    fun messageTypeForMime(mime: String): com.whispernet.android.model.WhispernetMessageType {
        val lower = mime.lowercase()
        return when {
            lower.startsWith("image/") -> com.whispernet.android.model.WhispernetMessageType.Image
            lower.startsWith("audio/") -> com.whispernet.android.model.WhispernetMessageType.Audio
            else -> com.whispernet.android.model.WhispernetMessageType.File
        }
    }
}
