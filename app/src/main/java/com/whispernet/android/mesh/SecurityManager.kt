...
class SecurityManager(private val encryptionService: EncryptionService, private val myPeerID: String) {
    ...
    companion object {
        ...
        private const val MESSAGE_TIMEOUT = com.whispernet.android.util.AppConstants.Security.MESSAGE_TIMEOUT_MS // 5 minutes (same as iOS)
        private const val CLEANUP_INTERVAL = com.whispernet.android.util.AppConstants.Security.CLEANUP_INTERVAL_MS // 5 minutes
        private const val MAX_PROCESSED_MESSAGES = com.whispernet.android.util.AppConstants.Security.MAX_PROCESSED_MESSAGES
        private const val MAX_PROCESSED_KEY_EXCHANGES = com.whispernet.android.util.AppConstants.Security.MAX_PROCESSED_KEY_EXCHANGES
    }
     ...
     */
    fun validatePacket(packet: WhispernetPacket, peerID: String): Boolean {
...
//        }
     ...
     */
    private fun generateMessageID(packet: WhispernetPacket, peerID: String): String {
     ...
     */
    private fun verifyPacketSignatureWithLogging(packet: WhispernetPacket, peerID: String) {
        try {
