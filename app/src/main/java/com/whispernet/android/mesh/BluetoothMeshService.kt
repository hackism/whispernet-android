package com.whispernet.android.mesh

import android.content.Context
import android.util.Log
import com.whispernet.android.crypto.EncryptionService
import com.whispernet.android.model.WhispernetMessage
import com.whispernet.android.protocol.MessagePadding
import com.whispernet.android.model.RoutedPacket
import com.whispernet.android.model.IdentityAnnouncement
import com.whispernet.android.protocol.WhispernetPacket
import com.whispernet.android.protocol.MessageType
import com.whispernet.android.protocol.SpecialRecipients
import com.whispernet.android.model.RequestSyncPacket
import com.whispernet.android.sync.GossipSyncManager
import com.whispernet.android.util.toHexString
...
class BluetoothMeshService(private val context: Context) {
    ...
    companion object {
        ...
        private val MAX_TTL: UByte = com.whispernet.android.util.AppConstants.MESSAGE_TTL_HOPS
    }
    ...
    init {
        ...
        gossipSyncManager = GossipSyncManager(
            ...
            configProvider = object : GossipSyncManager.ConfigProvider {
                override fun seenCapacity(): Int = try {
                    com.whispernet.android.ui.debug.DebugPreferenceManager.getSeenPacketCapacity(500)
                } catch (_: Exception) { 500 }

                override fun gcsMaxBytes(): Int = try {
                    com.whispernet.android.ui.debug.DebugPreferenceManager.getGcsMaxFilterBytes(400)
                } catch (_: Exception) { 400 }

                override fun gcsTargetFpr(): Double = try {
                    com.whispernet.android.ui.debug.DebugPreferenceManager.getGcsFprPercent(1.0) / 100.0
        ...
        gossipSyncManager.delegate = object : GossipSyncManager.Delegate {
            override fun sendPacket(packet: WhispernetPacket) {
                connectionManager.broadcastPacket(RoutedPacket(packet))
            }
            override fun sendPacketToPeer(peerID: String, packet: WhispernetPacket) {
                connectionManager.sendPacketToPeer(peerID, packet)
            }
            override fun signPacketForBroadcast(packet: WhispernetPacket): WhispernetPacket {
    ...
    private fun setupDelegates() {
        ...
        securityManager.delegate = object : SecurityManagerDelegate {
            ...
            override fun sendHandshakeResponse(peerID: String, response: ByteArray) {
                ...
                val responsePacket = WhispernetPacket(
                    version = 1u,
        ...
        messageHandler.delegate = object : MessageHandlerDelegate {
            ...
            override fun verifySignature(packet: WhispernetPacket, peerID: String): Boolean {
            ...
            override fun updatePeerIDBinding(newPeerID: String, nickname: String,
                ...
                try {
                    com.whispernet.android.favorites.FavoritesPersistenceService.shared.findNostrPubkey(publicKey)?.let { npub ->
                        com.whispernet.android.favorites.FavoritesPersistenceService.shared.updateNostrPublicKeyForPeerID(newPeerID, npub)
                    }
                } catch (_: Exception) { }
            ...
            // Callbacks
            override fun onMessageReceived(message: WhispernetMessage) {
        ...
        packetProcessor.delegate = object : PacketProcessorDelegate {
            override fun validatePacketSecurity(packet: WhispernetPacket, peerID: String): Boolean {
            ...
            override fun handleFragment(packet: WhispernetPacket): WhispernetPacket? {
        ...
        connectionManager.delegate = object : BluetoothConnectionManagerDelegate {
            override fun onPacketReceived(packet: WhispernetPacket, peerID: String, device: android.bluetooth.BluetoothDevice?) {
            ...
            override fun onDeviceConnected(device: android.bluetooth.BluetoothDevice) {
                ...
                try {
                    ...
                    com.whispernet.android.ui.debug.DebugSettingsManager.getInstance()
     ...
     */
    fun sendFileBroadcast(file: com.whispernet.android.model.WhispernetFilePacket) {
        try {
     ...
     */
    fun sendFilePrivate(recipientPeerID: String, file: com.whispernet.android.model.WhispernetFilePacket) {
        try {
            ...
            serviceScope.launch {
                ...
                if (encryptionService.hasEstablishedSession(recipientPeerID)) {
                    try {
                        ...
                        val noisePayload = com.whispernet.android.model.NoisePayload(
                            type = com.whispernet.android.model.NoisePayloadType.FILE_TRANSFER,
                            data = filePayload
                        )
                        ...
                        val packet = WhispernetPacket(
                            ...
                            payload = encrypted,
                            signature = null,
                            ttl = com.whispernet.android.util.AppConstants.MESSAGE_TTL_HOPS
                        )
        ...
        serviceScope.launch {
            ...
            if (encryptionService.hasEstablishedSession(recipientPeerID)) {
                try {
                    ...
                    val privateMessage = com.whispernet.android.model.PrivateMessagePacket(
                    ...
                    val messagePayload = com.whispernet.android.model.NoisePayload(
                        type = com.whispernet.android.model.NoisePayloadType.PRIVATE_MESSAGE,
                        data = tlvData
                    )
    ...
    fun sendReadReceipt(messageID: String, recipientPeerID: String, readerNickname: String) {
        serviceScope.launch {
            ...
            val geo = runCatching { com.whispernet.android.services.MessageRouter.tryGetInstance() }.getOrNull()
            val isGeoAlias = try {
                val map = com.whispernet.android.nostr.GeohashAliasRegistry.snapshot()
                map.containsKey(recipientPeerID)
            } catch (_: Exception) { false }
            if (isGeoAlias && geo != null) {
                geo.sendReadReceipt(com.whispernet.android.model.ReadReceipt(messageID), recipientPeerID)
                return@launch
            }
            
            try {
                // Create read receipt payload using NoisePayloadType exactly like iOS
                val readReceiptPayload = com.whispernet.android.model.NoisePayload(
                    type = com.whispernet.android.model.NoisePayloadType.READ_RECEIPT,
                ...
                val packet = WhispernetPacket(
                    ...
                    payload = encrypted,
                    signature = null,
                    ttl = com.whispernet.android.util.AppConstants.MESSAGE_TTL_HOPS // Same TTL as iOS messageTTL
                )
    ...
    fun sendBroadcastAnnounce() {
        ...
        serviceScope.launch {
            ...
            val announcePacket = WhispernetPacket(
     ...
     */
    fun getSessionState(peerID: String): com.whispernet.android.noise.NoiseSession.NoiseSessionState {
     ...
     */
    private fun signPacketBeforeBroadcast(packet: WhispernetPacket): WhispernetPacket {
        return try {
...
interface BluetoothMeshDelegate {
    fun didReceiveMessage(message: WhispernetMessage)
