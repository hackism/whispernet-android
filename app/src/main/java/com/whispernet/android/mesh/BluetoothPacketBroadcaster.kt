...
class BluetoothPacketBroadcaster(
    ...
    companion object {
        ...
        private const val CLEANUP_DELAY = com.whispernet.android.util.AppConstants.Mesh.BROADCAST_CLEANUP_DELAY_MS
    }
    ...
    private fun logPacketRelay(
        ...
        try {
            ...
            com.whispernet.android.ui.debug.DebugSettingsManager.getInstance().logPacketRelayDetailed(
                packetType = typeName,
