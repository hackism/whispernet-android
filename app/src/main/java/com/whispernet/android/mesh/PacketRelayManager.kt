 ...
 * 
 * This class handles all relay decisions and logic for whispernet packets.
...
class PacketRelayManager(private val myPeerID: String) {
    ...
    private fun isRelayEnabled(): Boolean = try {
        com.whispernet.android.ui.debug.DebugSettingsManager.getInstance().packetRelayEnabled.value
     ...
     */
    internal fun isPacketAddressedToMe(packet: WhispernetPacket): Boolean {
     ...
     */
    private fun shouldRelayPacket(packet: WhispernetPacket, fromPeerID: String): Boolean {
