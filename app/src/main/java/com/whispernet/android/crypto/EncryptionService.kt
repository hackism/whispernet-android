package com.whispernet.android.crypto

import android.content.Context
import android.util.Log
import com.whispernet.android.noise.NoiseEncryptionService
 ...
 * 
 * This is the main interface for all encryption/decryption operations in whispernet.
...
class EncryptionService(private val context: Context) {
    ...
    fun clearPersistentIdentity() {
        ...
        try {
            val prefs = context.getSharedPreferences("whispernet_crypto", Context.MODE_PRIVATE)
