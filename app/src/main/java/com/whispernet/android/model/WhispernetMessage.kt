...
@Parcelize
enum class WhispernetMessageType : Parcelable {
    Message,
    Audio,
    Image,
    File
...
/**
 * WhispernetMessage - 100% compatible with iOS version
 */
@Parcelize
data class WhispernetMessage(
    val id: String = UUID.randomUUID().toString().uppercase(),
    val sender: String,
    val content: String,
    val type: WhispernetMessageType = WhispernetMessageType.Message,
    val timestamp: Date,
    ...
    companion object {
         ...
         */
        fun fromBinaryPayload(data: ByteArray): WhispernetMessage? {
            try {
                ...
                return WhispernetMessage(
                    id = id,
                    sender = sender,
                    content = content,
                    type = WhispernetMessageType.Message,
                    timestamp = timestamp,
                    isRelay = isRelay,
