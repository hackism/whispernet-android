...
import com.whispernet.android.geohash.ChannelID
import kotlinx.coroutines.launch
import com.whispernet.android.geohash.GeohashChannel
import com.whispernet.android.geohash.GeohashChannelLevel
import com.whispernet.android.geohash.LocationChannelManager
import com.whispernet.android.geohash.GeohashBookmarksStore
import com.whispernet.android.ui.theme.BASE_FONT_SIZE
...
private fun meshTitleWithCount(viewModel: ChatViewModel): String {
    ...
    val peopleText = ctx.resources.getQuantityString(com.whispernet.android.R.plurals.people_count, meshCount, meshCount)
    val meshLabel = stringResource(com.whispernet.android.R.string.mesh_label)
...
private fun geohashTitleWithCount(channel: GeohashChannel, participantCount: Int): String {
    val ctx = androidx.compose.ui.platform.LocalContext.current
    val peopleText = ctx.resources.getQuantityString(com.whispernet.android.R.plurals.people_count, participantCount, participantCount)
    val levelName = when (channel.level) {
        com.whispernet.android.geohash.GeohashChannelLevel.BLOCK -> stringResource(com.whispernet.android.R.string.location_level_block)
        com.whispernet.android.geohash.GeohashChannelLevel.NEIGHBORHOOD -> stringResource(com.whispernet.android.R.string.location_level_neighborhood)
        com.whispernet.android.geohash.GeohashChannelLevel.CITY -> stringResource(com.whispernet.android.R.string.location_level_city)
        com.whispernet.android.geohash.GeohashChannelLevel.PROVINCE -> stringResource(com.whispernet.android.R.string.location_level_province)
        com.whispernet.android.geohash.GeohashChannelLevel.REGION -> stringResource(com.whispernet.android.R.string.location_level_region)
    }
