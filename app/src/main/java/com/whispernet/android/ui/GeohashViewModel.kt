...
import com.whispernet.android.nostr.GeohashMessageHandler
import com.whispernet.android.nostr.GeohashRepository
import com.whispernet.android.nostr.NostrDirectMessageHandler
import com.whispernet.android.nostr.NostrIdentityBridge
import com.whispernet.android.nostr.NostrProtocol
import com.whispernet.android.nostr.NostrRelayManager
import com.whispernet.android.nostr.NostrSubscriptionManager
...
class GeohashViewModel(
    ...
    private var locationChannelManager: com.whispernet.android.geohash.LocationChannelManager? = null
    ...
    fun initialize() {
        ...
        try {
            locationChannelManager = com.whispernet.android.geohash.LocationChannelManager.getInstance(getApplication())
            ...
            state.setSelectedLocationChannel(com.whispernet.android.geohash.ChannelID.Mesh)
    ...
    fun sendGeohashMessage(content: String, channel: com.whispernet.android.geohash.GeohashChannel, myPeerID: String, nickname: String?) {
        viewModelScope.launch {
            try {
                ...
                val localMsg = com.whispernet.android.model.WhispernetMessage(
                    id = tempId,
                ...
                if (startedMining) {
                    com.whispernet.android.ui.PoWMiningTracker.startMiningMessage(tempId)
                }
                try {
                    ...
                    if (startedMining) {
                        com.whispernet.android.ui.PoWMiningTracker.stopMiningMessage(tempId)
                    }
                }
            } catch (e: Exception) {
    ...
    fun startGeohashDM(pubkeyHex: String, onStartPrivateChat: (String) -> Unit) {
        ...
        val gh = (current as? com.whispernet.android.geohash.ChannelID.Location)?.channel?.geohash
        if (!gh.isNullOrEmpty()) {
            repo.setConversationGeohash(convKey, gh)
            com.whispernet.android.nostr.GeohashConversationRegistry.set(convKey, gh)
        }
    ...
    fun blockUserInGeohash(targetNickname: String) {
        ...
        if (pubkey != null) {
            ...
            val sysMsg = com.whispernet.android.model.WhispernetMessage(
                sender = "system",
    ...
    private fun switchLocationChannel(channel: com.whispernet.android.geohash.ChannelID?) {
        ...
        when (channel) {
            is com.whispernet.android.geohash.ChannelID.Mesh -> {
            ...
            is com.whispernet.android.geohash.ChannelID.Location -> {
                ...
                viewModelScope.launch {
                    ...
                    com.whispernet.android.nostr.GeohashAliasRegistry.put("nostr_${dmIdentity.publicKeyHex.take(16)}", dmIdentity.publicKeyHex)
                }
            }
            null -> {
