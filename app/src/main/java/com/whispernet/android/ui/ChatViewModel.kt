package com.whispernet.android.ui
...
import com.whispernet.android.mesh.BluetoothMeshDelegate
import com.whispernet.android.mesh.BluetoothMeshService
import com.whispernet.android.model.WhispernetMessage
import com.whispernet.android.model.WhispernetMessageType
import com.whispernet.android.protocol.WhispernetPacket


import kotlinx.coroutines.launch
import com.whispernet.android.util.NotificationIntervalManager
...
/**
 * Refactored ChatViewModel - Main coordinator for whispernet functionality
...
class ChatViewModel(
    ...
    private val debugManager by lazy { try { com.whispernet.android.ui.debug.DebugSettingsManager.getInstance() } catch (e: Exception) { null } }
    ...
    val messages: LiveData<List<WhispernetMessage>> = state.messages
    ...
    val privateChats: LiveData<Map<String, List<WhispernetMessage>>> = state.privateChats
    ...
    val channelMessages: LiveData<Map<String, List<WhispernetMessage>>> = state.channelMessages
    ...
    val selectedLocationChannel: LiveData<com.whispernet.android.geohash.ChannelID?> = state.selectedLocationChannel
    ...
    init {
        ...
        viewModelScope.launch {
            com.whispernet.android.mesh.TransferProgressManager.events.collect { evt ->
    ...
    private fun loadAndInitialize() {
        ...
        viewModelScope.launch {
            com.whispernet.android.ui.debug.DebugSettingsManager.getInstance().debugMessages.collect { msgs ->
                if (com.whispernet.android.ui.debug.DebugSettingsManager.getInstance().verboseLoggingEnabled.value) {
                    ...
                    if (selectedLocation is com.whispernet.android.geohash.ChannelID.Mesh) {
        ...
        com.whispernet.android.favorites.FavoritesPersistenceService.initialize(getApplication())


        // Ensure NostrTransport knows our mesh peer ID for embedded packets
        try {
            val nostrTransport = com.whispernet.android.nostr.NostrTransport.getInstance(getApplication())
    ...
    private fun ensureGeohashDMSubscriptionIfNeeded(convKey: String) {
        try {
            ...
            val repo = repoField.get(geohashViewModel) as com.whispernet.android.nostr.GeohashRepository
            ...
            if (!gh.isNullOrEmpty()) {
                ...
                val subMgr = subMgrField.get(geohashViewModel) as com.whispernet.android.nostr.NostrSubscriptionManager
                val identity = com.whispernet.android.nostr.NostrIdentityBridge.deriveIdentity(gh, getApplication())
                val subId = "geo-dm-$gh"
                ...
                if (currentId != subId) {
                    ...
                    subMgr.subscribeGiftWraps(
                        ...
                        handler = { event ->
                            ...
                            val dmHandler = dmHandlerField.get(geohashViewModel) as com.whispernet.android.nostr.NostrDirectMessageHandler
    ...
    fun startPrivateChat(peerID: String) {
        ...
        if (success) {
            ...
            try {
                val seen = com.whispernet.android.services.SeenMessageStore.getInstance(getApplication())
    ...
    fun openLatestUnreadPrivateChat() {
        try {
            ...
            val openPeer: String = if (targetKey.startsWith("nostr_")) {
                ...
                val canonical = com.whispernet.android.services.ConversationAliasResolver.resolveCanonicalPeerID(
                    ...
                    nostrPubHexForAlias = { alias -> com.whispernet.android.nostr.GeohashAliasRegistry.get(alias) },
                    findNoiseKeyForNostr = { key -> com.whispernet.android.favorites.FavoritesPersistenceService.shared.findNoiseKey(key) }
                )
                canonical ?: targetKey
            }
    ...
    fun sendMessage(content: String) {
        ...
        if (content.startsWith("/")) {
            ...
            commandProcessor.processCommand(content, meshService, meshService.myPeerID, { messageContent, mentions, channel ->
                if (selectedLocationForCommand is com.whispernet.android.geohash.ChannelID.Location) {
        ...
        if (selectedPeer != null) {
            ...
            selectedPeer = com.whispernet.android.services.ConversationAliasResolver.resolveCanonicalPeerID(
            ...
            privateChatManager.sendPrivateMessage(
                ...
                val router = com.whispernet.android.services.MessageRouter.getInstance(getApplication(), meshService)
                router.sendPrivate(messageContent, peerID, recipientNicknameParam, messageId)
            }
        } else {
            // Check if we're in a location channel
            val selectedLocationChannel = state.selectedLocationChannel.value
            if (selectedLocationChannel is com.whispernet.android.geohash.ChannelID.Location) {
    ...
    fun toggleFavorite(peerID: String) {
        ...
        try {
            ...
            if (peerInfo?.noisePublicKey != null) {
                ...
                if (peerID.length == 64 && peerID.matches(Regex("^[0-9a-fA-F]+$"))) {
                    try {
                        ...
                        val rel = com.whispernet.android.favorites.FavoritesPersistenceService.shared.getFavoriteStatus(noiseKey!!)
            ...
            if (noiseKey != null) {
                ...
                val identityManager = com.whispernet.android.identity.SecureIdentityStateManager(getApplication())
                ...
                com.whispernet.android.favorites.FavoritesPersistenceService.shared.updateFavoriteStatus(
                ...
                try {
                    val myNostr = com.whispernet.android.nostr.NostrIdentityBridge.getCurrentNostrIdentity(getApplication())
    ...
    private fun updateReactiveStates() {
        ...
        sessionStates.forEach { (peerID, newState) ->
            ...
            if (old != "established" && newState == "established") {
                com.whispernet.android.services.MessageRouter
    ...
    override fun didReceiveMessage(message: WhispernetMessage) {
    ...
    fun panicClearAllData() {
        ...
        try {
            ...
            try {
                val store = com.whispernet.android.geohash.GeohashBookmarksStore.getInstance(getApplication())
                store.clearAll()
            } catch (_: Exception) { }
    ...
    private fun clearAllCryptographicData() {
        try {
            ...
            try {
                com.whispernet.android.favorites.FavoritesPersistenceService.shared.clearAllFavorites()
    ...
    fun selectLocationChannel(channel: com.whispernet.android.geohash.ChannelID) {
