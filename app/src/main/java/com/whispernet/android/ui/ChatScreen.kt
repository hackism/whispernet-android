...
import com.whispernet.android.ui.media.FullScreenImageViewer
...
fun ChatScreen(viewModel: ChatViewModel) {
    ...
    var selectedMessageForSheet by remember { mutableStateOf<WhispernetMessage?>(null) }
    ...
    val displayMessages = when {
        ...
        currentChannel != null -> channelMessages[currentChannel] ?: emptyList()
            ...
            if (locationChannel is com.whispernet.android.geohash.ChannelID.Location) {
        ...
        Column(
            ...
            MessagesList(
                ...
                onNicknameClick = { fullSenderName ->
                    ...
                    val mentionText = if (selectedLocationChannel is com.whispernet.android.geohash.ChannelID.Location && hashSuffix.isNotEmpty()) {
    ...
    androidx.compose.runtime.LaunchedEffect(Unit) {
        com.whispernet.android.ui.events.FileShareDispatcher.setHandler { peer, channel, path ->
            ...
            Surface(
                ...
                IconButton(onClick = { forceScrollToBottom = !forceScrollToBottom }) {
                    Icon(
                        ...
                        contentDescription = stringResource(com.whispernet.android.R.string.cd_scroll_to_bottom),
...
private fun ChatDialogs(
    ...
    selectedMessageForSheet: WhispernetMessage?,
    viewModel: ChatViewModel
) {
    // Password dialog
    ...
    if (showDebugSheet) {
        com.whispernet.android.ui.debug.DebugSettingsSheet(
