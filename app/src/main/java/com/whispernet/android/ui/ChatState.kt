...
class ChatState {
    ...
    private val _messages = MutableLiveData<List<WhispernetMessage>>(emptyList())
    val messages: LiveData<List<WhispernetMessage>> = _messages
    ...
    // Private chats
    private val _privateChats = MutableLiveData<Map<String, List<WhispernetMessage>>>(emptyMap())
    val privateChats: LiveData<Map<String, List<WhispernetMessage>>> = _privateChats
    ...
    private val _channelMessages = MutableLiveData<Map<String, List<WhispernetMessage>>>(emptyMap())
    val channelMessages: LiveData<Map<String, List<WhispernetMessage>>> = _channelMessages
    ...
    private val _selectedLocationChannel = MutableLiveData<com.whispernet.android.geohash.ChannelID?>(com.whispernet.android.geohash.ChannelID.Mesh)
    val selectedLocationChannel: LiveData<com.whispernet.android.geohash.ChannelID?> = _selectedLocationChannel
    ...
    fun setMessages(messages: List<WhispernetMessage>) {
    ...
    fun setPrivateChats(chats: Map<String, List<WhispernetMessage>>) {
    ...
    fun setChannelMessages(messages: Map<String, List<WhispernetMessage>>) {
    ...
    fun setSelectedLocationChannel(channel: com.whispernet.android.geohash.ChannelID?) {
