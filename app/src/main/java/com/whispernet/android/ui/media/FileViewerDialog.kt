...
import com.whispernet.android.features.file.FileUtils
 ...
 */
private fun tryOpenFile(context: Context, packet: WhispernetFilePacket) {
    try {
        // First try to save to temp file and open
        val tempFile = File.createTempFile("whispernet_", ".${packet.fileName.substringAfterLast(".")}", context.cacheDir)
