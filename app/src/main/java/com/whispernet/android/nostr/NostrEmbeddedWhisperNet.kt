...
import com.whispernet.android.model.PrivateMessagePacket
...
/**
 * WhisperNet-over-Nostr Adapter
 * Direct port from iOS implementation for 100% compatibility
 */
object NostrEmbeddedWhisperNet {
    
    private const val TAG = "NostrEmbeddedWhisperNet"
    
    /**
     * Build a `whispernet1:` base64url-encoded WhisperNet packet carrying a private message for Nostr DMs.
     */
    fun encodePMForNostr(
        ...
        try {
            ...
            return "whispernet1:" + base64URLEncode(data)
        } catch (e: Exception) {
    ...
    /**
     * Build a `whispernet1:` base64url-encoded WhisperNet packet carrying a delivery/read ack for Nostr DMs.
     */
    ...
    /**
     * Build a `whispernet1:` ACK (delivered/read) without an embedded recipient peer ID (geohash DMs).
     */
    ...
    /**
     * Build a `whispernet1:` payload without an embedded recipient peer ID (used for geohash DMs).
     */
