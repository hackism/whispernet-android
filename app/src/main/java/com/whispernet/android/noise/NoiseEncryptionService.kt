package com.whispernet.android.noise

import android.content.Context
import android.util.Log
import com.whispernet.android.identity.SecureIdentityStateManager
import com.whispernet.android.mesh.PeerFingerprintManager
import com.whispernet.android.noise.southernstorm.protocol.Noise
...
class NoiseEncryptionService(private val context: Context) {
    ...
    companion object {
        ...
        private const val REKEY_TIME_LIMIT = com.whispernet.android.util.AppConstants.Noise.REKEY_TIME_LIMIT_MS // 1 hour (same as iOS)
        private const val REKEY_MESSAGE_LIMIT = com.whispernet.android.util.AppConstants.Noise.REKEY_MESSAGE_LIMIT_ENCRYPTION // 1k messages (matches iOS) (same as iOS)
    }
    ...
    private fun generateKeyPair(): Pair<ByteArray, ByteArray> {
        try {
            val dhState = com.whispernet.android.noise.southernstorm.protocol.Noise.createDH("25519")
    ...
    /**
     * Sign a WhispernetPacket using our Ed25519 signing key
     */
    fun signPacket(packet: com.whispernet.android.protocol.WhispernetPacket): com.whispernet.android.protocol.WhispernetPacket? {
    ...
    /**
     * Verify a WhispernetPacket signature using the provided public key
     */
    fun verifyPacketSignature(packet: com.whispernet.android.protocol.WhispernetPacket, publicKey: ByteArray): Boolean {
