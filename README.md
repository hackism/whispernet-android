<p align="center">
    <img src="app/src/main/assets/icon.jpeg" alt="Whispernet Android Logo" width="480">
</p>
...
You can download the latest version of whispernet for Android from the [GitHub Releases page](https://github.com/).
...
- **✅ Dark/Light Themes**: Terminal-inspired aesthetic matching Command-Line Terminal
...
2. **Open in Android Studio:**
   ...
   # Navigate to the whispernet-android directory
   ```
...
3. **Launch whispernet** - it will auto-start mesh networking
...
### Binary Protocol
whispernet uses an efficient binary protocol optimized for Bluetooth LE:
...
1. **WhispernetApplication.kt**: Application-level initialization and dependency injection
...
6. **ChatScreen.kt**: Jetpack Compose UI with Material Design 3
...
- **Target API**: Android API (< 25) Anbdroid 8 or Later
...
- **Security Issues**: Email security concerns privately (harrism711@yahoo.com)
